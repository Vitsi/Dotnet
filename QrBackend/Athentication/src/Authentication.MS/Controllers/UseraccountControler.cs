...
namespace Authentication.Ms.Controllers
{
    ...
    public class UseraccountController : ControllerBase
    {
        ...
        [Authorize(Roles = "Admin")]
        [HttpPut("UpgradeToAdmin/{id}")]
        public async Task<ActionResult> UpgradeUserToAdminAsync(Guid id)
        {
            try
            {
                ...
                // Update the username to start with "admin_"
                existingUser.Username = "admin_" + existingUser.Username;
            ...
            {
                _logger.LogError(ex, "An error occurred while upgrading a user to admin.");
                return StatusCode(500, "Internal Server Error");
            }
        }
